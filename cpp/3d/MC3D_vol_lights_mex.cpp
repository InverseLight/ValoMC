...
void mexFunction(int nlhs, mxArray **plhs, int nrhs, const mxArray **prhs)
{
  ...
  if ((nrhs != 20) || ((nlhs != 5) && (nlhs != 6)))
  {
    ...
    mexErrMsgTxt("Syntax:\n [vsol, bsol, ebsol, simulationtime, rnseed, [HN]] = MC3Dmex(H, HN, BH, r, BCType, BCIntensity, BCLightDirectionType, BCLNormal, BCn, mua, mus, g, n, f, phase0, Nphoton, disablepbar, rnseed, volumetriclight,volfrac)\n");
  }
  ...
  Convert_mxArray(prhs[18], volumetriclight);
  Convert_mxArray(prhs[19], volfrac);
...
//  Convert_mxArray(prhs[15], GaussianSigma); 
  ...
  MC.phase0 = phase0[0];
  MC.volumetriclight = volumetriclight;
  MC.volumetriclightFraction = volfrac[0];
